...
<div id="emp_datagrid_tb">
    <div>
     <c:if test="${myFn:checkPermission('com.mu.web.controller.EmployeeController:add')}">
            <a class="easyui-linkbutton" iconCls="icon-add" plain="true" data-cmd="add">新增</a>
        </c:if>
<c:if test="${myFn:checkPermission('com.mu.web.controller.EmployeeController:update')}">
