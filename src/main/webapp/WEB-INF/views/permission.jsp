...
<%@taglib prefix="myFn" uri="http://www.mu.com/permission" %>
<html>
<head>
    <title>权限管理</title>
...
<div id="permission_datagrid_tb">
    <div>
          <c:if test="${myFn:checkPermission('com.mu.web.controller.PermissionController:add')}">
            <a class="easyui-linkbutton" iconCls="icon-add" plain="true" data-cmd="add">新增</a>
        </c:if>
<c:if test="${myFn:checkPermission('com.mu.web.controller.PermissionController:update')}">
